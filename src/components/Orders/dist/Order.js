...
var Order = function (_a) {
    ...
    return (react_1["default"].createElement("div", { key: order.id },
        ...
        (currentUser === null || currentUser === void 0 ? void 0 : currentUser.role) === "customer" && order.current_user === "customer" && !order.accepted ? (react_1["default"].createElement(react_1["default"].Fragment, null,
            ...
            react_1["default"].createElement("button", null, "Confirm order"),
            react_1["default"].createElement("button", { onClick: function () { return handleRole(order.current_user, order.id); } }, "Suggest changes"))) : (currentUser === null || currentUser === void 0 ? void 0 : currentUser.role) === "merchant" && order.current_user === "customer" && !order.accepted ? (react_1["default"].createElement("p", null, "Waiting for the customer to confirm your order.")) : (react_1["default"].createElement("p", { style: { color: "#0a0" } }, "Order accepted")),
