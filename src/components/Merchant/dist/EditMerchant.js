...
var EditMerchant = function (_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("form", { onSubmit: handleSubmit },
            ...
            react_1["default"].createElement("input", { type: "text", name: "merchantName", value: merchantName, onChange: handleInput, placeholder: currentMerchant.merchant_name }),
            react_1["default"].createElement("br", null),
            react_1["default"].createElement("label", null, "Phone Number"),
            react_1["default"].createElement("input", { type: "text", name: "phoneNumber", value: phoneNumber, onChange: handleInput, placeholder: currentMerchant.phone_number }),
            react_1["default"].createElement("br", null),
            react_1["default"].createElement("label", null, "Tax ID"),
            react_1["default"].createElement("input", { type: "text", name: "taxId", value: taxId, onChange: handleInput, placeholder: currentMerchant.tax_id }),
            react_1["default"].createElement("br", null),
